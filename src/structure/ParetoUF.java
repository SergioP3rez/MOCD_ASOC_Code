...
public class ParetoUF {

    private static List<MOCDSolutionUnionFind> front;
    ...
    public synchronized static boolean add(MOCDSolutionUnionFind newSol) {
        ...
        boolean enter = true;
        int idx = 0;
        for (MOCDSolutionUnionFind frontSol : front) {
        ...
        if (enter) {
            MOCDSolutionUnionFind solCopy = new MOCDSolutionUnionFind(newSol);
            front.add(solCopy);
    ...
    public static synchronized List<MOCDSolutionUnionFind> getFront() {
        return front;
    }

    public static String toText() {
        StringBuilder stb = new StringBuilder();
        for (MOCDSolutionUnionFind sol : front) {
            stb.append(sol.getClusters()).append("\t").append("MinNRA: ").append(sol.getNraToPrint()).append("\t").append("MinRC: ").append(sol.getRcToPrint()).append("\n").append("Modularity: ").append(sol.getModularity()).append("\n");
        }
        return stb.toString();
    }
    ...
    public static String toText2() {
        StringBuilder stb = new StringBuilder();
        for (MOCDSolutionUnionFind sol : front) {
            stb.append(sol.getNraToPrint()).append("\t").append(sol.getRcToPrint()).append("\n");
        }
        return stb.toString();
    }
